...
<div id="breadcrumb" class="section">
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-12">
				<h3 class="breadcrumb-header">Xác nhận thông tin</h3>
			...
			<div class="col-md-6 order-details">
				...
				<div class="order-summary">
					...
					<div class="order-products">
						...
						<div class="order-col">
							<div>${crt.soluong}x ${crt.ten}</div>
							<div>${crt.soluong * crt.gia} VNĐ</div>
						</div>
						</c:forEach>
					</div>
					<div class="order-col">
				...
				<div class="payment-method">
					<div class="input-radio">
						...
						<div class="caption">
							<p>Hãy chuyển khoản vào tài khoản sau: sxxx-cxxx-axxx-mxxx</p>
						</div>
					</div>
					<div class="input-radio">
						...
						<div class="caption">
							<p>Hãy thanh toán khi bạn nhận hàng</p>
						</div>
					</div>
				</div>
				...
				<a href="/checkout?action=insert" class="primary-btn order-submit">Mua ngay</a>
			</div>
			<!-- /Order Details -->
		</div>
		<div class="col-md-3"></div>
