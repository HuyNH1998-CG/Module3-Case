					...
					<div class="d-flex justify-content-center row">
						<div class="col-md-8">
							...
							<div class="d-flex flex-row justify-content-between align-items-center p-2 bg-white mt-4 px-3 rounded">
								...
								<div>
									<h5 class="text-grey">${carts.gia * carts.soluong} VNĐ</h5>
								</div>
								<div class="d-flex align-items-center"><a href="/cart?action=remove&id=${carts.id}"><i class="fa fa-trash mb-1 text-danger"></i></a></div>
							</div>
							</c:forEach>
							<div class="d-flex flex-row align-items-center mt-3 p-2 bg-white rounded"><a href="/checkout" class="btn btn-warning btn-block btn-lg ml-2 pay-button">Mua Ngay</a></div>
							<div class="d-flex align-items-center"><a href="/cart?action=removeall"><i class="fa fa-trash mb-1 text-danger">Xóa hết</i></a></div>
						</div>
					</div>
				</div>
				<!-- /row -->
