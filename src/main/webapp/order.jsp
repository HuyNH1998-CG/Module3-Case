                ...
                <div class="col-md-8">
                    <c:forEach var="DH" items="${DonHang}">
                        <div class="d-flex flex-row justify-content-between align-items-center p-2 bg-white mt-4 px-3 rounded">
                            <div class="d-flex flex-column align-items-center product-details"><span class="font-weight-bold"><a href="/order?action=detail&id=${DH.orderID}">Ma Don Hang: ${DH.orderID}</a></span>
                                <div class="d-flex flex-row product-desc">
                                    <div class="size mr-1"><span class="text-grey">Ngày Đặt:</span><span class="font-weight-bold">&nbsp;${DH.date}</span></div>
                                </div>
                            </div>
                            <div class="d-flex flex-row align-items-center qty">
                                <h5 class="text-grey mt-1 mr-1 ml-1">${carts.soluong}x</h5></a>
                            </div>
                            <div>
                                <h5 class="text-grey">${DH.total} VNĐ</h5>
                            </div>
                            <div class="d-flex align-items-center"><a href="/order?action=delete&id=${DH.orderID}"><i class="fa fa-trash mb-1 text-danger"></i></a></div>
                        </div>
                    </c:forEach>
                </div>
            </div>
