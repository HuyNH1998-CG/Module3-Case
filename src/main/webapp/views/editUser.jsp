...
<div id="breadcrumb" class="section">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                <h3 class="breadcrumb-header">Sửa Thông tin người dùng</h3>
    ...
    <div class="container">
        ...
        <div class="container mt-5 mb-5">
            <div class="d-flex justify-content-center row">
                <div class="col-md-8">
                    <form method="post" action="/account?action=edituser">
                        <table>
                            ...
                            <tr>
                                <th>Name</th>
                                <td><input type="text" name="ten" value="${user.ten}"></td>
                            </tr>
                            <tr>
                                <th>NgaySinh</th>
                                <td><input type="text" name="ngaysinh" value="${user.ngaySinh}"></td>
                            </tr>
                            <tr>
                                <th>SoDT</th>
                                <td><input type="text" name="sdt" value="${user.soDT}"></td>
                            </tr>
                            <tr>
                                <th>Address</th>
