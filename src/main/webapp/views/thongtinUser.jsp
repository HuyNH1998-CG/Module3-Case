...
<div id="breadcrumb" class="section">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                <h3 class="breadcrumb-header">Thông tin người dùng</h3>
                ...
                <div class="col-md-8">
                    <table>
                        <tr>
                            ...
                            <td>Name:<input type="text" name="name" value="${user.ten}"></td>
                            <td>Role: <input type="text"name="role" value="${user.role}"></td>
                            <td><a href="/account?action=edit&id=${user.id}"class="btn btn-danger">Edit</a></td>
                        </tr>
                    </table>
                </div>
            </div>
