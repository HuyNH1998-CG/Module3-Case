        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <ul class="breadcrumb-tree">
                    <li><a href="/">Home</a></li>
                    <li><a href="/order?action=view">Đơn Hàng</a></li>
                ...
                <div class="order-summary">
                    ...
                    <div class="order-products">
                        <c:forEach var="ord" items="${orders}">
                            <div class="order-col">
                                <div>${ord.soluong}x ${ord.ten}</div>
                                <div>$${ord.soluong * ord.gia} VNĐ</div>
                            </div>
                        </c:forEach>
                    </div>
                    <div class="order-col">
                        <div><strong>Tổng</strong></div>
                        <div><strong class="order-total">${total} VNĐ</strong></div>
                    </div>
                </div>
                <!-- /Order Details -->
            </div>
