            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="header-search">
                        <form action="/?action=search2" method="post">
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-xs-6">
                <div class="shop">
                    ...
                    <div class="shop-body">
                        <h3>Plastic Model<br>Collection</h3>
                        <a href="/?action=search&id=1" class="cta-btn">Shop now <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </div>
            <!-- /shop -->
            ...
            <div class="col-md-4 col-xs-6">
                <div class="shop">
                    ...
                    <div class="shop-body">
                        <h3>Kotobuki<br>Collection</h3>
                        <a href="/?action=search&id=2" class="cta-btn">Shop now <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </div>
            <!-- /shop -->
            ...
            <div class="col-md-4 col-xs-6">
                <div class="shop">
                    ...
                    <div class="shop-body">
                        <h3>Hobby Tools<br>Collection</h3>
                        <a href="/?action=search&id=3" class="cta-btn">Shop now <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </div>
            <!-- /shop -->
                        ...
                        <div class="col-md-4 col-xs-6">
                            <div class="product">
                                ...
                                <div class="add-to-cart">
                                    <a href="/cart?action=add&id=${prd.id}" class="add-to-cart-btn"><i
