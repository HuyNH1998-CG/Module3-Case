                ...
                <div class="col-md-8">
                    <form method="post">
                        <table>
                            <tr>
                                <th>Ten Hang</th>
                                <td><input type="text" name="name" value="${sanpham.ten}"></td>
                            </tr>
                            <tr>
                                <th>Gia</th>
                                <td><input type="text" name="price" value="${sanpham.gia}"></td>
                            </tr>
                            <tr>
                                <th>Mo Ta</th>
                                <td><textarea name="desc" cols="30" rows="10" value="${sanpham.mota}"></textarea></td>
                            </tr>
                            <tr>
                                <th>Hinh anh</th>
                                <td><input type="text" name="image" value="${sanpham.hinhanh}"></td>
                            </tr>
                            <tr>
                                <th>Phan loai</th>
                            ...
                            <tr>
                                <th>So luong</th>
                                <td><input type="number" name="amount" value="${sanpham.trongKho}"></td>
                            </tr>
                        </table>
