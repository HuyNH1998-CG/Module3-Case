...
public class UserDAO {
    ...
    public List<KhachHang> login() throws SQLException {
        ...
        query = "select id,username,password,role,ten from users;";
        statement = connection.prepareStatement(query);
        ...
        while (rs.next()) {
            ...
            user.add(new KhachHang(id, username, password, ten, role));
        }
        return user;
    }
    ...
    public KhachHang getAccount(int id) throws SQLException {
        ...
        while (rs.next()) {
            ...
            String role = rs.getString("role");
            String ten = rs.getString("ten");
            user = new KhachHang(id, username, password, ten, role);
        }
        return user;
    }
}
